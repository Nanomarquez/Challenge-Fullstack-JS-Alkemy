...
var require_transformer = __commonJS({
  "node_modules/@sweetalert/transformer/dist/transformer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function _interopDefault(ex) {
      return ex && typeof ex === "object" && "default" in ex ? ex["default"] : ex;
    }
    var swal = _interopDefault(require_sweetalert_min());
    var index = async (...args) => {
      const newOptions = await getOptions(...args);
      return swal(newOptions);
    };
    var bindActions = (swalInstance) => {
      for (const method in swal) {
        swalInstance[method] = swal[method];
      }
    };
    var getOptions = async (params, {
      identifier,
      transformer
    }) => {
    ...
    var isOptionsParam = (param, isTransformable) => param.constructor === Object && !isTransformable(param);
    var transformParams = async (params, isTransformable, transformer) => {
    ...
    var transformEl = async (el, transformer, isAsync) => {
...
var require_sweetalert = __commonJS({
  "node_modules/@sweetalert/with-react/dist/sweetalert.js"(exports, module) {
    "use strict";
    function _interopDefault(ex) {
      return ex && typeof ex === "object" && "default" in ex ? ex["default"] : ex;
    }
    ...
    var getDOMNodeFromJSX = (Element2) => {
      const wrapper = document.createElement("div");
      return new Promise((resolve) => {
        ReactDOM.render(Element2, wrapper, () => {
          const el = wrapper.firstChild;
          return resolve(el);
        });
      });
    };
    var swal = (...params) => transformer__default(params, {
...
// dep:@sweetalert_with-react
var sweetalert_with_react_default = require_sweetalert();
export {
  sweetalert_with_react_default as default
};
//# sourceMappingURL=@sweetalert_with-react.js.map
